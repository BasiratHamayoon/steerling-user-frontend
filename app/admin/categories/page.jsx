...
import { FaPlus, FaEdit, FaTrash, FaImage, FaBox, FaSearch, FaFilter, FaCalendarAlt } from 'react-icons/fa';
...
export default function AdminCategoriesPage() {
  ...
  // ---- Fetch Data ----
  // This is the fixed part. We use a standard useEffect dependent on the filter values.
  useEffect(() => {
    let isMounted = true;
  ...
  // ^ dependencies ensure fetch runs only when these change
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-4 flex flex-col md:flex-row gap-4 items-center justify-between shadow-lg">
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          ...
          <div className="relative w-full md:w-48">
            ...
            <div className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 pointer-events-none text-xs">
              ▼
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 text-sm text-gray-400">
          ...
          {(localSearch || statusFilter !== 'all') && (
            <button
              ...
              className="text-[#0295E6] hover:text-white underline decoration-dashed"
            >
              Reset Filters
            </button>
          )}
            ...
            >
              ...
              <div className="relative h-48 overflow-hidden bg-gray-950">
                <img
                  ...
                  onError={(e) => {
                    ...
                    e.target.src = '/placeholder-category.jpg'; // Ensure you have a placeholder
                  }}
                />
                  ...
                  >
                    <span
                      className={`w-1.5 h-1.5 rounded-full ${
                        category.isActive ? 'bg-green-400 animate-pulse' : 'bg-red-400'
                      }`}
                    />
              ...
              <div className="p-5 flex flex-col flex-1">
                <div className="flex justify-between items-start mb-2">
                  <h3 className="text-xl font-bold text-white line-clamp-1 group-hover:text-[#0295E6] transition-colors">
                    {category.name}
                  </h3>
                ...
                <div className="pt-4 border-t border-gray-800 flex justify-between items-center text-xs text-gray-500 font-mono">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="truncate max-w-[80px]" title={category._id}>
